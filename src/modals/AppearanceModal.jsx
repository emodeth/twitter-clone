...
function AppearanceModal() {
  ...
  return (
    <div className="w-[600px] flex flex-col items-center">
      <h3 className="mt-8 mb-3 text-[23px] leading-7 font-extrabold">
        Görünümü özelleştir
      </h3>
      <div className="p-8 pt-0">
        <p className="text-[color:var(--color-base-secondary)] leading-5 mb-5 text-center">
          Bu ayarlar, bu tarayıcıdaki tüm X hesaplarını etkiler.
        </p>
        <div className="mx-8 mb-4">
          <div className="border border-[color:var(--background-tertiary)] px-4 flex py-3 gap-3 rounded-2xl">
            <img
            ...
            <div className="flex flex-col flex-1">
              <header className="mb-0.5 flex items-center">
                <span className="font-bold leading-5">X</span>
                <svg
                  viewBox="0 0 22 22"
                  height={18.75}
                ...
                <span className="ml-1 flex items-center leading-5 text-[color:var(--color-base-secondary)]">
                  @X · 31d
                </span>
              </header>
        ...
        <div className="flex items-center justify-center">
          <Button onClick={() => setModal(false)}>Bitti</Button>
        </div>
      </div>
    </div>
  );
